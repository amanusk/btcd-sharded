...
func calcInputValueAge(tx *wire.MsgTx, utxoView blockchain.UtxoView, nextBlockHeight int32) float64 {
...
func CalcPriority(tx *wire.MsgTx, utxoView blockchain.UtxoView, nextBlockHeight int32) float64 {
